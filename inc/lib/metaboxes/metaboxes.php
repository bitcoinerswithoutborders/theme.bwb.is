...
$subpostings = BwB_Metabox_Generator::getInstance('subpostings', array(
...
$subroles = BwB_Metabox_Generator::getInstance('subroles', array(
...
$subdisplay = BwB_Metabox_Generator::getInstance('subdisplay', array(
